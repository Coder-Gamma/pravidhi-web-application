              ...
              {footerLinks.social.map((item) => {
                ...
                return (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex h-10 w-10 items-center justify-center rounded-md text-muted hover:text-accent transition-all  transform hover:-translate-y-1 "
                    target="_blank"
                    rel="noreferrer"
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <input
                ...
                className=" h-11 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm focus:border-accent focus:outline-none"
              />
